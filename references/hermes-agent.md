...
Use this reference when Qimo Speedrun runs inside Hermes Agent or another agent that can persist files, create scheduled tasks, and send messages through QQ, WeChat, or another message gateway.
